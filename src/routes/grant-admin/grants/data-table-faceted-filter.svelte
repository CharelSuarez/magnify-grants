<script lang="ts">
	...
	import type { trueFalseFilter } from './filter-types';

	export let filterValues: string[] = [];
	export let title: string;
	export let options = [] as typeof trueFalseFilter;
...
<Popover.Root bind:open>
	<Popover.Trigger asChild let:builder>
		<Button builders={[builder]} class="h-8 border-dashed" size="sm" variant="outline">
