export const translations:{ [locale: string]: {[key: string]: string}} = {
	"en": {
		...
		"card.users.content": "50 applicants",
		...
		"card.sectors.education": "Education: 27%",
		"card.sectors.research": "Research: 43%",
		"card.sectors.smallBusiness": "Small business: 13%",
		"card.sectors.nonProfit": "Non-profit: 17%",
	...
	"fr": {
		...
		"card.users.content": "50 candidats",
		...
		"card.sectors.education": "Éducation : 27 %",
		"card.sectors.research": "Recherche : 43 %",
		"card.sectors.smallBusiness": "Petite entreprise : 13 %",
		"card.sectors.nonProfit": "Organisme sans but lucratif : 17 %",
